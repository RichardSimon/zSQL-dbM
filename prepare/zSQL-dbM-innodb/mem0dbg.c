...
#include "srv0srv.h" //z+ //因为srv_use_sys_malloc //----2011-09-20-13-56;
//UNIV_INTERN
//void
//mem_init(
///*=====*/
//	ulint	size)	/*!< in: common pool size in bytes */
//{  //z //(2011-09-20-13-23)----2011-09-20-13-33:/--13-40:此函数的声明在mem0mem.h
////UNIV_INTERN 
//void mem_init(int size){ //z //----2011-09-20-13-57:/--13-59本文件中的其他几处的此问题解决了(/都是由于srv0srv.h！；)--2011-00-20-14-00;
...
//{  //z //----2011-09-20-13-50;
//static void mem_print_info_low(int print_all){
static void mem_print_info_low(ibool print_all){
