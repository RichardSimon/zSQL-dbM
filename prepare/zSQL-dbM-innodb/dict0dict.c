...
#include "univ.i" //z+ //为了dict_init函数中的UNIV_WORD_SIZE(=>UNIV_WORD_SIZE)
#define SIZEOF_LONG  4 //z+
/**********************************************************************//**
...
//		innobase_convert_from_id(cs, dst, str, len);  //z-
...
//		innobase_convert_from_table_id(cs, dst, str, len);  //z-
	}
...
//	cs = innobase_get_charset(trx->mysql_thd);  //z-

	*n = 0;

	*constraints_to_drop = mem_heap_alloc(heap, 1000 * sizeof(char*));

//	ptr = innobase_get_stmt(trx->mysql_thd, &len);  //z-
