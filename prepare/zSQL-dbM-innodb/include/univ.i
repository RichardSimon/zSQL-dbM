...
//z# include <my_global.h>
//z# include <my_pthread.h>
#endif /* UNIV_HOTBACKUP */
...
#include "my_global.h" //+(2011-09-20-09-31;)
#ifdef __WIN__
typedef __int64			ib_int64_t;
typedef unsigned __int64	ib_uint64_t;
#elif !defined(UNIV_HOTBACKUP)
/* Note: longlong and ulonglong come from MySQL headers. */
//typedef long long int  longlong;  //z+ //zlq@zlq:~/InnoSQL-5.5.8/include$ cat my_*.h | grep "longlong;"
//typedef unsigned long long int  ulonglong; //z+ //z-(2011-09-20-09-29/my_global.h;)
